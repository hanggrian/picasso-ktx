...
const val VERSION_BANNERBAR = "$VERSION_ANDROIDX-SNAPSHOT"
const val VERSION_PREFY = "0.1-SNAPSHOT"
...
fun Dependencies.square(module: String, version: String) = "com.squareup.$module:$module:$version"
